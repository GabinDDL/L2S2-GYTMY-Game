...
public class TestDepthFirstGenerator {
  ...
  public void testConstructorInvalidStart() {
    ...
    TestingUtils.assertArgumentExceptionMessage(() -> new DepthFirstGenerator().generate(5, 5, new Coordinates(0, 0)),
        expectedErrorMessage);
    TestingUtils.assertArgumentExceptionMessage(() -> new DepthFirstGenerator().generate(5, 5, new Coordinates(4, 4)),
        expectedErrorMessage);
    TestingUtils.assertArgumentExceptionMessage(() -> new DepthFirstGenerator().generate(5, 5, new Coordinates(5, 5)),
        expectedErrorMessage);
  }
